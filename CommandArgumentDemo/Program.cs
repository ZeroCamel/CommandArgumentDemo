...
namespace CommandArgumentDemo
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //string dllFile = dir.GetFiles("HJ.QM.NSYY.IS.dll").Select(File => File.FullName).FirstOrDefault();
            //Assembly.LoadFrom(dllFile);
            //foreach (Assembly ab in AppDomain.CurrentDomain.GetAssemblies())
            //{
            //    string a = ab.GetName().Name;
            //    string b = "HJ.QM.NSYY.IS";
            //    if (string.Equals(a, b, StringComparison.OrdinalIgnoreCase))
            //    {
            //        Console.WriteLine(ab.FullName);
            //        Console.WriteLine(ab.GetType("Filter.FilterHandler"));
            ...
            //}
            //int[] a = new int[] { 3, 3 };
            //int[] temp = TwoSum2(a, 6);
            //for (int i = 0; i < temp.Length; i++)
            //{
            //    Console.WriteLine(temp[i]);
            //}
            //string s = Regex.Replace("20：40,34：", "(：[0-9]{0,2})", "");
            //Console.WriteLine(s);
            ...
            ListNode root = AddTwoNumbers(root5, l6);
            while (root != null)
            {
            ...
            //强制性安全
            CodeAccessPermission perssion = new FileIOPermission(FileIOPermissionAccess.AllAccess,@"F:");


            Console.WriteLine(LengthOfLongestSubstring_1(s));
            Console.ReadKey();
        ...
        public static int LengthOfLongestSubstring_1(string s)
        {
            ...
            for (i = 0, j = 0; i < s.Length; i++)
            {
                ...
                {
                    int value;
                    dict.TryGetValue(s.ElementAt(i), out value);
                    j = Math.Max(j, value + 1);
                    dict.Remove(s.ElementAt(i));
                }
                dict.Add(s.ElementAt(i), i);
        ...
        public static int[] TwoSum1(int[] nums, int target)
        {
            ...
            {
                int b = target - nums[i];
                int j = array.IndexOf(b);
                if (nums.Contains<int>(b) && j != i)
                {
                    temp[0] = i;
                    temp[1] = j;
                    return temp;
